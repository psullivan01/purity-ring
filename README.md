...
1. [Overview](#overview)
2. [Features](#features)
   - [String Splitting](#1-string-splitting)
   - [Character Mapping](#2-character-mapping)
   - [Blacklist Management](#3-blacklist-management)
...
Due to the nature of Purity Ring's string splitting method — determining the best string split based on word frequency data — and the uniqueness of some blacklisted terms, not all blacklist entries are treated the same. Purity Ring classifies blacklisted terms into three categories to improve accuracy:
